...
By using this repository or any code related to it, you agree to the [legal notice](gpt4free/LEGAL_NOTICE.md). The author is not responsible for any copies, forks, or reuploads made by other users. This is the author's only account and repository. To prevent impersonation or irresponsible actions, you may comply with the GNU GPL license this Repository uses.
...
1. create a new file in [g4f/Provider/Providers](gpt4free/g4f/Provider/Providers) with the name of the Provider
2. in the file, paste the *Boilerplate* you can find in [g4f/Provider/Provider.py](gpt4free/g4f/Provider/Provider.py): 
